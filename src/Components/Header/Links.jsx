		...
		<>
			...
			<div className={s.LinkWrapper}>
				<div className={s.linkLineWrapper}>
					...
					<a className={s.link} target='_blank' rel='noopener noreferrer'
						...
						<img className={s.linkImg} src={socialnetwork} alt="Social network"/><span
						className={s.linkTitle}>Social_Network</span>
					</a>
					<a className={s.link} target='_blank' rel='noopener noreferrer'
			...
			<div>
				<a className={s.linkPost} target='_blank' rel='noopener noreferrer'
					...
					<img className={s.linkImg} src={mail} alt="Social network"/><span
					className={s.linkTitle}>Spamoglot13@gmail.com</span>
				</a>
			</div>
		</>
	)
